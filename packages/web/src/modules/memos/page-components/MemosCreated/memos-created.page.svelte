...
<PageContent rowGap="unset">
  <Surface
    ...
    marginBottom="l4"
  >
    <TitleH1 marginBottom="m">{$LL.memos.memoCreated()}</TitleH1>

    <TitleH3>{$LL.memos.memoCreatedMessage()}</TitleH3>
  </Surface>

  <div class="success-container">
    <Paragraph marginBottom="s">
      <TitleH3 fontSize="l2">{$LL.memos.whatDoYouWantToDoNow()}</TitleH3>
    </Paragraph>
